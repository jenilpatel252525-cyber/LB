...
export default function Register(){
    ...
    return(
        <div className="bg-gray-400 h-screen flex justify-center items-center">
            <div className="border-2 rounded-2xl bg-cyan-50 w-1/2 h-1/2 flex justify-center items-center flex-col space-y-2">
                <form className="flex justify-center items-center flex-col space-y-2" onSubmit={onclick}>
                    ...
                    <button className="hover:bg-blue-600 bg-blue-400  w-full rounded" type="submit">Submit</button>
                </form>
